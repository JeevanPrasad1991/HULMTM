...
public class AfterStockActivity extends Activity implements OnClickListener {
    ...
    GSKMTDatabase db;
    public String image1 = "", image2 = "", image3 = "", _path, date, imgDate, image4 = "", img1 = "", img2 = "", img = "", str, _pathforcheck_gap = "",
            _pathforcheck = "", _pathforcheck1 = "", paked_key, state_id, key_id, class_id, storename, cat_name, store_id, category_id,
            process_id, intime, username, app_version, store_type_id, error_msg = "", primary_windowIssues = "";
    ...
    boolean isDialogOpen = true, check = true, update1 = false, update = false;
    static int currentVersion = 1, child_position = -1, row_pos = 10000, mposition = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isTablet(context)) {
            ...
            mKeyboard = new Keyboard(context, R.xml.keyboard1);
        }

        mKeyboardView = (CustomKeyboardView) findViewById(R.id.keyboard_view);
        mKeyboardView.setKeyboard(mKeyboard);
        mKeyboardView.setOnKeyboardActionListener(new BasicOnKeyboardActionListener((Activity) context));
        ...
        if (category_id != null && category_id.equals("2")) {
            ...
            sos_target.setText("Stock - " + cat_name);
        }
        ...
        if (sku_brand_list.size() == 0) {
            ...
            if (sku_brand_list.size() > 0) {
                ...
                adaptorfor_stock = new MyAdaptor(context, paked_key);
                ...
                if (stock_images_list.size() > 0) {
                    ...
                    for (int i = 0; i < stock_images_list.size(); i++) {
                        if (!stock_images_list.get(i).getImage5().equals("")) {
                        ...
                        if (!stock_images_list.get(i).getImage6().equals("")) {
                        ...
                        if (!stock_images_list.get(i).getImage7().equals("")) {
                        ...
                        if (!stock_images_list.get(i).getImage8().equals("")) {
        ...
        primarywindow.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog2 = new Dialog(context, R.style.theme_sms_receive_dialog);
                ...
                lv2.setAdapter(new skulistDataOther(context));
        ...
        shelf_visibility.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (db.getPdrForSelfData(process_id, state_id, store_type_id, category_id, key_id).size() > 0) {
                    ...
                    lv2.setAdapter(new ShelfVisibility(context));
    ...
    private class MyAdaptor extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.faceup.setOnFocusChangeListener(new OnFocusChangeListener() {
                public void onFocusChange(View v, boolean hasFocus) {
                    if (!hasFocus) {
                        ...
                        final EditText Caption = (EditText) v;
                        String value1 = Caption.getText().toString().replaceFirst("^0+(?!$)", "");
                        if (!sku_brand_list.get(position).getCompany_id().equals("1")) {
                            if (value1.equals("")) {
                            ...
                            ////for HUL Product....for PDR
                            if (sku_brand_list.get(position).getAfter_Stock().equals("")) {
                                if (isDialogOpen) {
                                    isDialogOpen = !isDialogOpen;
                                    AlertDialog.Builder builder = new AlertDialog.Builder(mcontext);
                                    String msg_str = "First Fill The 'STOCK'";
                                ...
                                if (value1.equals("")) {
                                    ...
                                    if (Integer.parseInt(value1) > Integer.parseInt(sku_brand_list.get(position).getAfter_Stock())) {
                                        if (isDialogOpen) {
                                            isDialogOpen = !isDialogOpen;
                                            AlertDialog.Builder builder = new AlertDialog.Builder(mcontext);
                                            String msg_str = "'FACEUP' cannot be greather than 'STOCK'";
                                            builder.setMessage(msg_str)
                                                    .setCancelable(false).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int id) {
                                                    dialog.dismiss();
            ...
            holder.last_three.setOnFocusChangeListener(new OnFocusChangeListener() {
                public void onFocusChange(View v, boolean hasFocus) {
                    if (!hasFocus) {
                        final int position = v.getId();
                        final EditText Caption = (EditText) v;
            ...
            if (!sku_brand_list.get(position).getCompany_id().equals("1")) {
                ...
                holder.faceup.setVisibility(View.VISIBLE);
                holder.faceup.setId(position);
            } else {
                if (sku_brand_list.get(position).getAfter_Stock().equals("0")) {
                    if (category_id != null && category_id.equals("2")) {
                        ...
                        holder.stockQuantity.setVisibility(View.VISIBLE);
                        holder.stockQuantity.setId(position);
                        holder.faceup.setVisibility(View.INVISIBLE);
                        holder.faceup.setId(position);
                        holder.l1.setBackgroundColor(Color.WHITE);
                        holder.l1.setId(position);
                        holder.l2.setVisibility(View.VISIBLE);
    ...
    public boolean validate_values() {
        boolean result = true;
        for (int i = 0; i < sku_brand_list.size(); i++) {
            if (sku_brand_list.get(i).getCompany_id().equals("1")) {
                if (category_id != null && category_id.equals("2")) {
                    if (sku_brand_list.get(i).getAfter_Stock().equals("")) {
                        result = false;
                        break;
                    } else if (sku_brand_list.get(i).getAfter_faceup().equals("")) {
                        result = false;
                        break;
                    }
                } else {
                ...
                if (category_id != null && category_id.equals("2") && sku_brand_list.get(i).getAfter_faceup().equals("")) {
                    result = false;
                    break;
                }
            }
    ...
    public boolean condition() {
        ...
        for (int i = 0; i < sku_brand_list.size(); i++) {
            if (sku_brand_list.get(i).getCompany_id().equals("1")) {
                if (category_id != null && category_id.equals("2")) {
                    if (!sku_brand_list.get(i).getAfter_Stock().equals("") && !sku_brand_list.get(i).getAfter_faceup().equals("")) {
                        int calculate_faceup = Integer.parseInt(sku_brand_list.get(i).getAfter_faceup());
                        if (calculate_faceup > Integer.parseInt(sku_brand_list.get(i).getAfter_Stock())) {
                            row_pos = i + 1;
                ...
                if (!sku_brand_list.get(i).getALAST_THREE().equals("")
                    ...
                    if (!paked_key.equalsIgnoreCase("n")) {
                        if ((Integer.parseInt(sku_brand_list.get(i).getALAST_THREE()) + Integer.parseInt(sku_brand_list.get(i).getAMORE_SIX()) +
                                Integer.parseInt(sku_brand_list.get(i).getATHREE_TO_SIX())) != (Integer.parseInt(sku_brand_list.get(i).getAfter_Stock()))) {
                            row_pos = i + 1;
                            list_view_for_stock.invalidateViews();
                            result = false;
                            break;
    ...
    public boolean validate_primaryWindows() {
        boolean result = true;
        if (!coveragelist.get(0).getImage_allow().equalsIgnoreCase("NOT Allowed")) {
            if (image1.equals("") && image2.equals("") && image3.equals("") && image4.equals("")) {
                result = false;
                                ...
                                if (validate_primaryWindows()) {
                                    if (validate_primaryWindowsData()) {
                                        if (conditionForPrimaryWindows()) {
                                            ...
                                            Toast.makeText(context, "Please fill questions in primary category ", Toast.LENGTH_LONG).show();
                                        }
                                    } else {
                                        db.open();
                                        sku_brand_list_second = db.getDisplayListAfterStock(category_id, store_id, process_id);
                                        Toast.makeText(context, "Please fill Primary window ", Toast.LENGTH_LONG).show();
                                    }
                                } else {
                                    Toast.makeText(context, "Please click image! ", Toast.LENGTH_LONG).show();
                                }
                            } else {
                                Toast.makeText(context, "Sum of entered stock should be equal to the total stock at line" + row_pos, Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Toast.makeText(context, "Invalid Faceup, Faceup Should Be Less " + "Than The Stock at line " + row_pos, Toast.LENGTH_LONG).show();
                        }
                    } else {
                        Toast.makeText(context, "Incorrect data ", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(context, "Enter Data In All Fields", Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(context, "Please fill Shelf Visibility", Toast.LENGTH_LONG).show();
            }
    ...
    private class skulistDataOther extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                CustomSpinnerAdapter skuadapter = new CustomSpinnerAdapter((AfterStockActivity) context, R.layout.custom_spinner_layout, ans_list);
